 ...
 * to a specified value. Notice that countMatching() is
 * generic, but MyArrayOps is not.
 */
...
public class GenericMethodRefDemo {
	...
	/*
	 * The method has the MyFunc functional interface as the
	 * type of its first parameter. The other tow parameters
