...
//Use an interface method reference with different objects.
...
class HighTemp {
	...
	//Return true if the invoking HighTemp object has a temperature that is les than ht2.
...
public class InstanceMethWithObjectRefDemo {
	...
	public static void main(String[] args) {
		...
		//Use counter() with arrays of the class HighTemp. Notice that a reference to the instance method sameTemp() is passed as the second argument.
