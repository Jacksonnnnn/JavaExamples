...
class Gen<T> {
	...
	//Pass that constructor a reference to an object of type T.
	Gen(T o) {
		ob = o;
	}
...
public class GenDemo {
	...
	public static void main(String[] args) {
		...
		//Create a Gen<Integer> object and assign its reference to iOb. Notice that the use of autoboxing to encapsulate the value 88 within an Integer object.
