...
//A marker anotation that can be applied to a type.
...
//Still another annotation that can be applied to a type.
@Target(ElementType.TYPE_USE)
@interface Unique {
...
class TypeAnnoDemo<@What (description = "Generic data type") T> {
	...
	public int f(me.Jackson.JavaExamples.TypeAnnoDemo<T> this, int x) {
		return 10;
	}
	...
	public static void myMeth(int i) {
		...
		@Unique TypeAnnoDemo<Integer> ob2 = new me.Jackson.JavaExamples.TypeAnnoDemo<Integer>();
	...
	class SomeClass extendsme.Jackson.JavaExamples.TypeAnnoDemo<Boolean> {}
}